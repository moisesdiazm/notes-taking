# ── ALBs: accept HTTP from the internet ──────────────────────────────────────
...
# ── ECS tasks: accept traffic only from their ALB ────────────────────────────
...
# ── RDS: accept PostgreSQL only from backend ECS tasks ───────────────────────
